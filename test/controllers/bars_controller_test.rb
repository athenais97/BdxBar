...
class BarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bar" do
    assert_difference('Bar.count') do
      post bars_url, params: { bar: { description: @bar.description, genre: @bar.genre, nom: @bar.nom } }
    end
  ...
  test "should update bar" do
    patch bar_url(@bar), params: { bar: { description: @bar.description, genre: @bar.genre, nom: @bar.nom } }
